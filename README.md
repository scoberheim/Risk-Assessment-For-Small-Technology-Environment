...
This repository documents the Governance, Risk and Compliance (GRC) work applied to my [Technical Security Lab](https://github.com/scoberheim/Technical-Security-Lab) homelab — a Proxmox/OPNsense environment built to practice security architecture, network segmentation, and risk management.
